...
uint8_t TCU_HCI_RESET_REQUEST[4] = {0x01, 0x03, 0x0C, 0x00};
uint8_t TCU_HCI_GET_FW_VERSION_REQ[13] = {0x01, 0x08, 0xFC, 0x09, 0x00, 0xA1, 0x00, 0x00, 0x00, 0x14, 0x0D, 0xFF, 0x00};
uint8_t TCU_HCI_M2_BTL_SET_I2C_ENABLE_REQ[15] = {0x01, 0x08, 0xFC, 0x0B, 0x00, 0xA0, 0x00, 0x00, 0x00, 0x14, 0x5B, 0xFF, 0x02, 0x01, 0x01};
uint8_t TCU_HCI_M2_BTL_EEPROM_WRITE_ENABLE_REQ[13] = {0x01, 0x08, 0xFC, 0x09, 0x00, 0xA0, 0x00, 0x00, 0x00, 0x14, 0x83, 0xFF, 0x00};
uint8_t TCU_HCI_M2_GENERAL_READ_EEPROM_BD_ADDR_REQ[20] = {0x01, 0x08, 0xFC, 0x10, 0x00, 0xA1, 0x00, 0x00, 0x00, 0x14, 0x88, 0xFF, 0x10, 0x06, 0xA0, 0x01, 0x01 ,0x06, 0x02, 0x00};
uint8_t TCU_HCI_WRITE_BD_ADDR_REQ[10] = {0x01, 0x13, 0x10, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t TCU_HCI_SET_MODE_REQ[7] = {0x01, 0x08, 0xFC, 0x03, 0x00, 0x99, 0x01};
uint8_t TCU_MNG_LE_INIT_REQ_ARR[11] = {0x0B, 0x00, 0x00, 0xD1, 0x01, 0x04, 0x00, 0x01, 0x00, 0x01, 0x01};
uint8_t TCU_LE_GATT_SER_INIT_REQ_ARR[7] = {0x07, 0x00, 0x00, 0xD3, 0x00, 0x00, 0x00};
uint8_t TCU_MNG_INIT_REQ[16] = {0x10, 0x00, 0x00, 0xE1, 0x01, 0x09, 0x00, 0x04, 0x02, 0x06, 0x75, 0x6E, 0x75, 0x73, 0x65, 0x64};
uint8_t TCU_LE_GATT_CLI_INIT_REQ[7] = {0x07, 0x00, 0x00, 0xD2, 0x00, 0x00, 0x00 };
...
*/
uint8_t TCU_LE_GATT_SDB_ADD_PRIM_SVC_REQ_ARR[10] = {0x0A, 0x00, 0x00, 0xD3, 0x20, 0x03, 0x00, 0x02, 0x00, 0x18};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ_ARR[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x01, 0x00, 0x02, 0x02, 0x00, 0x2A};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_VAR_ELE_REQ[23] = {0x17, 0x00, 0x00, 0xD3, 0x2C, 0x10, 0x00, 0x10, 0x00, 0x02, 0x00, 0x2A, 0x0D, 0x00, 0x05, 0x00, 0x42, 0x49, 0x4F, 0x44, 0x59, 0x00, 0x00};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ2[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x01, 0x00, 0x02, 0x02, 0x01, 0x2A};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_ELE_REQ_ARR[18] = {0x12, 0x00, 0x00, 0xD3, 0x23, 0x0B, 0x00, 0x20, 0x00, 0x02, 0x01, 0x2A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t TCU_LE_GATT_SDB_ADD_PRIM_SVC_REQ2[10] = {0x0A, 0x00, 0x00, 0xD3, 0x20, 0x03, 0x00, 0x02, 0x0A, 0x18};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ3[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x00, 0x01, 0x02, 0x02, 0x29, 0x2A};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_ELE_REQ2[25] = {0x19, 0x00, 0x00, 0xD3, 0x23, 0x12, 0x00, 0x10, 0x01, 0x02, 0x29,
			0x2A, 0x09, 0x00, 0x41, 0x6D, 0x69, 0x6E, 0x6F, 0x67, 0x72, 0x61, 0x6D, 0x00, 0x00};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ4[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x00, 0x01, 0x02, 0x02, 0x24, 0x2A};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_ELE_REQ3[27] = {0x1B, 0x00, 0x00, 0xD3, 0x23, 0x14, 0x00, 0x20, 0x01, 0x02, 0x24,
			0x2A, 0x0B, 0x00, 0x4D, 0x6F, 0x64, 0x65, 0x6C, 0x6E, 0x75, 0x6D, 0x62, 0x65, 0x72, 0x00, 0x00};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ5[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x00, 0x01, 0x02, 0x02, 0x23, 0x2A};
...
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ6[13] = {0x0D, 0x00, 0x00, 0xD3, 0x22, 0x06, 0x00, 0x00, 0x01, 0x02, 0x02, 0x27, 0x2A};
...
uint8_t TCU_LE_GATT_SDB_ADD_PRIM_SVC_REQ3[24] = {0x18, 0x00, 0x00, 0xD3, 0x20, 0x11, 0x00, 0x10, 0x1B, 0xC5, 0xD5,
			0xA5, 0x02, 0x00, 0x03, 0xA9, 0xE3, 0x11, 0x8B, 0xAA, 0xA0, 0xC6, 0x79, 0xE0};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_DECL_REQ7[27] = {0x1B, 0x00, 0x00, 0xD3, 0x22, 0x14, 0x00, 0x00, 0x02, 0x28, 0x10,
			0x1B, 0xC5, 0xD5, 0xA5, 0x02, 0x00, 0xEF, 0x9C, 0xE3, 0x11, 0x89, 0xAA, 0xC0, 0x12, 0x83, 0xB3};
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_VAR_ELE_REQ2[189] = {0xBD, 0x00, 0x00, 0xD3, 0x2C, 0xB6, 0x00, 0x10, 0x02, 0x10,
...
uint8_t TCU_LE_GATT_SDB_ADD_CHAR_ELE_REQ6[18] = {0x12, 0x00, 0x00, 0xD3, 0x23, 0x0B, 0x00, 0x10, 0x02, 0x02, 0x02,
